...
public class TGroupDatabaseMetaData implements DatabaseMetaData {
	...
	public TGroupDatabaseMetaData(TGroupConnection tGroupConnection,
	...
	public DatabaseMetaData getDatabaseMetaData() throws SQLException {
		...
		try {
//			conn = tGroupConnection.createNewConnection(wBaseDsWrapper, false);
	...
	public ResultSet getAttributes(String catalog, String schemaPattern,
			...
			throws SQLException {
		return getDatabaseMetaData().getAttributes(catalog, schemaPattern,
				typeNamePattern, attributeNamePattern);
	}
	public ResultSet getBestRowIdentifier(String catalog, String schema,
			String table, int scope, boolean nullable) throws SQLException {
		return getDatabaseMetaData().getBestRowIdentifier(catalog, schema, table,
				scope, nullable);
	}
	...
	public ResultSet getColumnPrivileges(String catalog, String schema,
		...
		return getDatabaseMetaData().getColumnPrivileges(catalog, schema, table,
				columnNamePattern);
	}
	...
	public ResultSet getCrossReference(String parentCatalog,
		...
		return getDatabaseMetaData().getCrossReference(parentCatalog, parentSchema,
	...
	public ResultSet getFunctionColumns(String catalog, String schemaPattern,
			...
			throws SQLException {
		return getDatabaseMetaData().getFunctionColumns(catalog, schemaPattern,
				functionNamePattern, columnNamePattern);
	}
	public ResultSet getFunctions(String catalog, String schemaPattern,
			String functionNamePattern) throws SQLException {
		return getDatabaseMetaData().getFunctions(catalog, schemaPattern,
				functionNamePattern);
	}
	...
	public ResultSet getIndexInfo(String catalog, String schema, String table,
		...
		return getDatabaseMetaData().getIndexInfo(catalog, schema, table, unique,
				approximate);
	}
	...
	public ResultSet getProcedureColumns(String catalog, String schemaPattern,
			...
			throws SQLException {
		return getDatabaseMetaData().getProcedureColumns(catalog, schemaPattern,
	...
	public ResultSet getSuperTables(String catalog, String schemaPattern,
		...
		return getDatabaseMetaData().getSuperTables(catalog, schemaPattern,
				tableNamePattern);
	}
	public ResultSet getSuperTypes(String catalog, String schemaPattern,
			String typeNamePattern) throws SQLException {
		return getDatabaseMetaData().getSuperTypes(catalog, schemaPattern,
				typeNamePattern);
	}

...
public class Samples implements Iterable<Map<String/*列名*/, Object/*列值*/>>, Iterator<Map<String, Object>> {
	...
	public Samples(Map<String, Set<Object>> oriColumnEnumerates1) {
		this.columnEnumerates = getRealColumnEnumerates(oriColumnEnumerates1);
	...
	private Map<String, Set<Object>> getRealColumnEnumerates(Map<String, Set<Object>> oriColumnEnumerates){
		if(oriColumnEnumerates.size() == 1)
			return oriColumnEnumerates;
		
		Map<String, Set<Object>> result = new HashMap<String, Set<Object>>();
		for(Entry<String, Set<Object>> entry : oriColumnEnumerates.entrySet()){

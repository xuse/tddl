package com.taobao.tddl.common.securety;
...
/**
 * 
 * COPY FROM @com.taobao.datasource.resource.security.SecureIdentityLoginModule
 * @author JIECHEN
 *
 */
public class SecureIdentityLoginModule {
	...
	public static void main(String[] args) throws Exception {
		System.out.println("Encoded password: " + new String(SecureIdentityLoginModule.encode("ssheartTB007writer")));
		System.out.println("decoded password: " + new String(SecureIdentityLoginModule.decode("a945741a53e60877183c1d314f5102209f526570957572b")));
	}
}

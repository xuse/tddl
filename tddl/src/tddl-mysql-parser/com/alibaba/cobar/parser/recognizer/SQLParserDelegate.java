...
public final class SQLParserDelegate {
    ...
    public static SQLStatement parse(MySQLLexer lexer, String charset) throws SQLSyntaxErrorException {
        try {
            ...
            throw new SQLSyntaxErrorException(re.getMessage(), re);
        }
    }

    public static SQLStatement parse(String sql, String charset) throws SQLSyntaxErrorException {
        return parse(new MySQLLexer(sql), charset);
    }

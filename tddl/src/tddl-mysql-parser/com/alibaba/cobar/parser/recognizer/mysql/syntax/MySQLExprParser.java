...
public class MySQLExprParser extends MySQLParser {
    ...
    private Expression intervalExpression() throws SQLSyntaxErrorException {
        ...
        case KW_SECOND_MICROSECOND:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.SECOND_MICROSECOND).setCacheEvalRst(cacheEvalRst);
        case KW_MINUTE_MICROSECOND:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.MINUTE_MICROSECOND).setCacheEvalRst(cacheEvalRst);
        case KW_MINUTE_SECOND:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.MINUTE_SECOND).setCacheEvalRst(cacheEvalRst);
        case KW_HOUR_MICROSECOND:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.HOUR_MICROSECOND).setCacheEvalRst(cacheEvalRst);
        case KW_HOUR_SECOND:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.HOUR_SECOND).setCacheEvalRst(cacheEvalRst);
        case KW_HOUR_MINUTE:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.HOUR_MINUTE).setCacheEvalRst(cacheEvalRst);
        case KW_DAY_MICROSECOND:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.DAY_MICROSECOND).setCacheEvalRst(cacheEvalRst);
        case KW_DAY_SECOND:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.DAY_SECOND).setCacheEvalRst(cacheEvalRst);
        case KW_DAY_MINUTE:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.DAY_MINUTE).setCacheEvalRst(cacheEvalRst);
        case KW_DAY_HOUR:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.DAY_HOUR).setCacheEvalRst(cacheEvalRst);
        case KW_YEAR_MONTH:
            lexer.nextToken();
            return new IntervalPrimary(fstExpr, IntervalPrimary.Unit.YEAR_MONTH).setCacheEvalRst(cacheEvalRst);
        case IDENTIFIER:
            String unitText = lexer.stringValueUppercase();
            IntervalPrimary.Unit unit = IntervalPrimary.getIntervalUnit(unitText);
            if (unit != null) {
                lexer.nextToken();
                return new IntervalPrimary(fstExpr, unit).setCacheEvalRst(cacheEvalRst);
            }
        default:

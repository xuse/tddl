...
public class ReplaceIntoVisitor extends EmptySQLASTVisitor {
	private MySqlStandardParserResult result;

	public ReplaceIntoVisitor(MySqlStandardParserResult result) {
		this.result = result;
	}
	...
	private void handleRow(DMLReplaceStatement node) {
	...
	private void handleTableName(DMLReplaceStatement node) {
